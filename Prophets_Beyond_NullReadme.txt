Prophet's Beyond Null Mod Combined Changelist for 2.5 to 2.65:
	(2/16/2025)
		...
		Inventory-D_InventoryInfo.json:
			Tier 4 food trough now slows decay rate of feed.
		Items-D_ItemStatic.json:
			Wood Fortification Entries added entra tags to accomodate Wood Structures Fix
		Stats-D_Stats.json:
			New Stat Entry added as part of the Robust Explorer/Healthy Maverick Talent fix.
